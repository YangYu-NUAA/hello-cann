...
| 单卡 LoRA | IT22HMDA_4_S，2 芯片，128 GB HBM | 同上 | 9.2.0 | 3.11.4 | 2.7.1+cpu | 2.7.1.post2.dev20251226 | Transformers 5.14.1、PEFT 0.19.1、Datasets 5.0.0 | 5 step 检查、3 epoch 训练、验证集评估、adapter 对比和权重合并已验证 |
