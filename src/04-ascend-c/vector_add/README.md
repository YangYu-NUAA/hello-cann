...
加载环境后，将 Toolkit 路径保存到 `ASCEND_INSTALL_PATH`：
...
自定义算子的安装、aclnn 调用和 PyTorch 侧封装见：
- `docs/zh/04-ascend-c/vector-add.md`（本算子教程）
- `docs/zh/04-ascend-c/model-integration.md`（接入 PyTorch）
